...
dataset_ref_to_datasets = {
    ...
    #"bpic2015": ["bpic2015_%s_f2_exp_prefix_new_1"%(municipality) for municipality in range(1,6)],
    ...
    "sepsis_cases": ["sepsis_cases_f%s"%formula for formula in [1,2,4]],
    #"sepsis_cases": ["sepsis_cases_f%s_exp_prefix_new"%formula for formula in [1,2,4]]
}
