...
#dataset_address = "/home/jongchan/Resource/codes/index_encoded_data_" + dataset_name + "_" + str(max_prefix) + ".csv"
...
for train_index, test_index in kf_no_resource.split(X_dummy_no_resource):
    ...
    index_no_resource += 1
dnn_auc_no_resource_arr[
    5] = "Average"  # To let users figure out that dnn_auc_no_resource[6] value is the average when seeing the csv file
dnn_auc_no_resource_arr[6] = (dnn_auc_no_resource_arr[0] + dnn_auc_no_resource_arr[1] + dnn_auc_no_resource_arr[2] +
                              dnn_auc_no_resource_arr[3] + dnn_auc_no_resource_arr[
                                  4]) / 5  # Averaging the auc values from kfold cv
rf_auc_no_resource_arr[5] = "Average"
rf_auc_no_resource_arr[6] = (rf_auc_no_resource_arr[0] + rf_auc_no_resource_arr[1] + rf_auc_no_resource_arr[2] +
                             rf_auc_no_resource_arr[3] + rf_auc_no_resource_arr[4]) / 5
xgb_auc_no_resource_arr[5] = "Average"
xgb_auc_no_resource_arr[6] = (xgb_auc_no_resource_arr[0] + xgb_auc_no_resource_arr[1] + xgb_auc_no_resource_arr[2] +
                              xgb_auc_no_resource_arr[3] + xgb_auc_no_resource_arr[4]) / 5
...
dnn_auc_yes_resource_arr[
    5] = "Average"  # To let users figure out that dnn_auc_yes_resource[6] value is the average when seeing the csv file
dnn_auc_yes_resource_arr[6] = (dnn_auc_yes_resource_arr[0] + dnn_auc_yes_resource_arr[1] + dnn_auc_yes_resource_arr[2] +
                               dnn_auc_yes_resource_arr[3] + dnn_auc_yes_resource_arr[
                                   4]) / 5  # Averaging the auc values from kfold cv
rf_auc_yes_resource_arr[5] = "Average"
rf_auc_yes_resource_arr[6] = (rf_auc_yes_resource_arr[0] + rf_auc_yes_resource_arr[1] + rf_auc_yes_resource_arr[2] +
                              rf_auc_yes_resource_arr[3] + rf_auc_yes_resource_arr[4]) / 5
xgb_auc_yes_resource_arr[5] = "Average"
xgb_auc_yes_resource_arr[6] = (xgb_auc_yes_resource_arr[0] + xgb_auc_yes_resource_arr[1] + xgb_auc_yes_resource_arr[2] +
                               xgb_auc_yes_resource_arr[3] + xgb_auc_yes_resource_arr[4]) / 5
